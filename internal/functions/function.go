...
func (s *Service) GetFunctionByNameAndVersion(ctx context.Context, name, version string) (result Function, err error) {
	res, err := s.cli.GetFunctionByNameAndVersion(ctx,
		&function_v1.GetFunctionByNameAndVersionRequest{
			FunctionName:    name,
