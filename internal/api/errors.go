...
var errorText = map[Err]string{
	...
	ParallelPathMixed:                   "invalid pipeline schema: parallel path's are mixed",
}
...
var errorDescription = map[Err]string{
	...
	GetBlockStateError:           "can't get block state",
	ParallelPathMixed:            "Процесс не опубликован. Внутри параллельности один из сокетов ведет на другую ветвь внутри параллельности",
}
