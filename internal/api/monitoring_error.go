...
func (ae *Env) getErrorDescription() string {
	...
	1. Получите права на доступ к индексу Jocasta на https://dashboards.obs.mts.ru/, для этого можно обратиться к Быкову Сергею (svbyk11@mts.ru), Смирновой Марии (mssmir23@mts.ru)
