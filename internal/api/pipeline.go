...
func (ae *APIEnv) GetPipeline(w http.ResponseWriter, req *http.Request, pipelineID PipelineID) {
...
func (ae *APIEnv) DeletePipeline(w http.ResponseWriter, req *http.Request, pipelineID PipelineID) {
...
func (ae *APIEnv) RunPipeline(w http.ResponseWriter, req *http.Request, pipelineID PipelineID) {
