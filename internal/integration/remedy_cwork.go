...
//nolint:gocritic //impossible to pass pointer
func (rs RemedySendCreateWork) Next(runCtx *store.VariableStore) (string, bool) {
...
//nolint:gocritic //impossible to pass pointer
func (rs RemedySendCreateWork) Update(_ context.Context, _ interface{}) (interface{}, error) {
	return nil, nil
}
