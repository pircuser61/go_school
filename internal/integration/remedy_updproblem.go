...
func (rs RemedySendUpdateProblem) GetType() string {
	return BlockIntegrationRemedyUpdateProblem
}
...
func (rs RemedySendUpdateProblem) DebugRun(ctx context.Context, runCtx *store.VariableStore) error {
	...
	u.Path = "/api/remedy/problem/update"
...
//nolint:gocritic //impossible to pass pointer
func (rs RemedySendUpdateProblem) Next(_ *store.VariableStore) (string, bool) {
...
//nolint:gocritic //impossible to pass pointer
func (rs RemedySendUpdateProblem) GetState() interface{} {
	return nil
}

//nolint:gocritic //impossible to pass pointer
func (rs RemedySendUpdateProblem) Update(_ context.Context, _ *script.BlockUpdateData) (interface{}, error) {
	return nil, nil
}
