...
//nolint:gocritic //impossible to pass pointer
func (rs RemedySendUpdateWork) Next(runCtx *store.VariableStore) (string, bool) {
...
//nolint:gocritic //impossible to pass pointer
func (rs RemedySendUpdateWork) Update(_ context.Context, _ interface{}) (interface{}, error) {
	return nil, nil
}
