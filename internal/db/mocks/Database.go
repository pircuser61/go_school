...
func (_m *MockedDatabase) CreateEmptyTask(ctx context.Context, task *db.Task) error {
...
func (_c *MockedDatabase_CreateEmptyTask_Call) Run(run func(ctx context.Context, task *db.Task)) *MockedDatabase_CreateEmptyTask_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*db.Task))
	})
	return _c
}
...
func (_c *MockedDatabase_CreateEmptyTask_Call) RunAndReturn(run func(context.Context, *db.Task) error) *MockedDatabase_CreateEmptyTask_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetNewWorkNumbers provides a mock function with given fields: ctx, prefetchSize
func (_m *MockedDatabase) GetNewWorkNumbers(ctx context.Context, prefetchSize int) ([]int, error) {
	ret := _m.Called(ctx, prefetchSize)

	if len(ret) == 0 {
		panic("no return value specified for GetNewWorkNumbers")
	}

	var r0 []int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) ([]int, error)); ok {
		return rf(ctx, prefetchSize)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int) []int); ok {
		r0 = rf(ctx, prefetchSize)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]int)
		}
...
// MockedDatabase_GetNewWorkNumbers_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetNewWorkNumbers'
type MockedDatabase_GetNewWorkNumbers_Call struct {
	*mock.Call
}

// GetNewWorkNumbers is a helper method to define mock.On call
//   - ctx context.Context
//   - prefetchSize int
func (_e *MockedDatabase_Expecter) GetNewWorkNumbers(ctx interface{}, prefetchSize interface{}) *MockedDatabase_GetNewWorkNumbers_Call {
	return &MockedDatabase_GetNewWorkNumbers_Call{Call: _e.mock.On("GetNewWorkNumbers", ctx, prefetchSize)}
}

func (_c *MockedDatabase_GetNewWorkNumbers_Call) Run(run func(ctx context.Context, prefetchSize int)) *MockedDatabase_GetNewWorkNumbers_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockedDatabase_GetNewWorkNumbers_Call) Return(_a0 []int, _a1 error) *MockedDatabase_GetNewWorkNumbers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockedDatabase_GetNewWorkNumbers_Call) RunAndReturn(run func(context.Context, int) ([]int, error)) *MockedDatabase_GetNewWorkNumbers_Call {
	_c.Call.Return(run)
	return _c
}
...
// NeedToNotifyProcessFinished provides a mock function with given fields: ctx, versionID
func (_m *MockedDatabase) NeedToNotifyProcessFinished(ctx context.Context, versionID uuid.UUID) (bool, error) {
	ret := _m.Called(ctx, versionID)

	if len(ret) == 0 {
		panic("no return value specified for NeedToNotifyProcessFinished")
	}
...
// MockedDatabase_NeedToNotifyProcessFinished_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NeedToNotifyProcessFinished'
type MockedDatabase_NeedToNotifyProcessFinished_Call struct {
	*mock.Call
}

// NeedToNotifyProcessFinished is a helper method to define mock.On call
//   - ctx context.Context
//   - versionID uuid.UUID
func (_e *MockedDatabase_Expecter) NeedToNotifyProcessFinished(ctx interface{}, versionID interface{}) *MockedDatabase_NeedToNotifyProcessFinished_Call {
	return &MockedDatabase_NeedToNotifyProcessFinished_Call{Call: _e.mock.On("NeedToNotifyProcessFinished", ctx, versionID)}
}

func (_c *MockedDatabase_NeedToNotifyProcessFinished_Call) Run(run func(ctx context.Context, versionID uuid.UUID)) *MockedDatabase_NeedToNotifyProcessFinished_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID))
	})
	return _c
...
func (_c *MockedDatabase_NeedToNotifyProcessFinished_Call) Return(_a0 bool, _a1 error) *MockedDatabase_NeedToNotifyProcessFinished_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockedDatabase_NeedToNotifyProcessFinished_Call) RunAndReturn(run func(context.Context, uuid.UUID) (bool, error)) *MockedDatabase_NeedToNotifyProcessFinished_Call {
	_c.Call.Return(run)
	return _c
}
