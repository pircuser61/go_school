...
func (_m *MockedDatabase) GetTaskMembers(ctx context.Context, workNumber string, fromActiveNodes bool) ([]db.DbMember, error) {
	ret := _m.Called(ctx, workNumber, fromActiveNodes)

	var r0 []db.DbMember
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) ([]db.DbMember, error)); ok {
		return rf(ctx, workNumber, fromActiveNodes)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) []db.DbMember); ok {
