...
// SaveVersionSettings provides a mock function with given fields: ctx, settings
func (_m *MockedDatabase) SaveVersionSettings(ctx context.Context, settings *entity.ProcessSettings) error {
	ret := _m.Called(ctx, settings)
