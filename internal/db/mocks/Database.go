...
// InitTaskBlock is a helper method to define mock.On call
//   - ctx context.Context
...
func (_c *MockedDatabase_InitTaskBlock_Call) Return(id uuid.UUID, startTime time.Time, err error) *MockedDatabase_InitTaskBlock_Call {
	_c.Call.Return(id, startTime, err)
	return _c
}
...
func (_m *MockedDatabase) SetTaskBlocksPaused(ctx context.Context, workID string, steps []string, isPaused bool) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for SetTaskBlocksPaused")
	}
...
// SetTaskBlocksPaused is a helper method to define mock.On call
//   - ctx context.Context
//   - workID string
//   - steps []string
//   - isPaused bool
...
func (_c *MockedDatabase_SetTaskBlocksPaused_Call) Return(_a0 error) *MockedDatabase_SetTaskBlocksPaused_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockedDatabase_SetTaskBlocksPaused_Call) RunAndReturn(run func(context.Context, string, []string, bool) error) *MockedDatabase_SetTaskBlocksPaused_Call {
	_c.Call.Return(run)
	return _c
}
