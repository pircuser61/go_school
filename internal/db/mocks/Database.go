...
// GetVersionsByBlueprintID provides a mock function with given fields: ctx, blueprintID
func (_m *MockedDatabase) GetVersionsByBlueprintID(ctx context.Context, blueprintID string) ([]entity.EriusScenario, error) {
