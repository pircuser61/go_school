...
func (_m *MockedDatabase) CheckTaskStepsExecuted(ctx context.Context, tx pgx.Tx, workNumber string, blocks []string) (bool, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, pgx.Tx, string, []string) bool); ok {
		r0 = rf(ctx, tx, workNumber, blocks)
	} else {
		r0 = ret.Get(0).(bool)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, pgx.Tx, string, []string) error); ok {
		r1 = rf(ctx, tx, workNumber, blocks)
	} else {
		r1 = ret.Error(1)
	}
...
// CheckUserCanEditForm provides a mock function with given fields: ctx, tx, workNumber, stepName, login
func (_m *MockedDatabase) CheckUserCanEditForm(ctx context.Context, tx pgx.Tx, workNumber string, stepName string, login string) (bool, error) {
	ret := _m.Called(ctx, tx, workNumber, stepName, login)

	var r0 bool
	if rf, ok := ret.Get(0).(func(context.Context, pgx.Tx, string, string, string) bool); ok {
		r0 = rf(ctx, tx, workNumber, stepName, login)
	} else {
		r0 = ret.Get(0).(bool)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, pgx.Tx, string, string, string) error); ok {
		r1 = rf(ctx, tx, workNumber, stepName, login)
	} else {
		r1 = ret.Error(1)
	}
...
// CreateTask provides a mock function with given fields: ctx, tx, dto
func (_m *MockedDatabase) CreateTask(ctx context.Context, tx pgx.Tx, dto *db.CreateTaskDTO) (*entity.EriusTask, error) {
	ret := _m.Called(ctx, tx, dto)

	var r0 *entity.EriusTask
	if rf, ok := ret.Get(0).(func(context.Context, pgx.Tx, *db.CreateTaskDTO) *entity.EriusTask); ok {
		r0 = rf(ctx, tx, dto)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, pgx.Tx, *db.CreateTaskDTO) error); ok {
		r1 = rf(ctx, tx, dto)
	} else {
		r1 = ret.Error(1)
	}
...
// GetParentTaskStepByName provides a mock function with given fields: ctx, tx, workID, stepName
func (_m *MockedDatabase) GetParentTaskStepByName(ctx context.Context, tx pgx.Tx, workID uuid.UUID, stepName string) (*entity.Step, error) {
	ret := _m.Called(ctx, tx, workID, stepName)

	var r0 *entity.Step
	if rf, ok := ret.Get(0).(func(context.Context, pgx.Tx, uuid.UUID, string) *entity.Step); ok {
		r0 = rf(ctx, tx, workID, stepName)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, pgx.Tx, uuid.UUID, string) error); ok {
		r1 = rf(ctx, tx, workID, stepName)
	} else {
		r1 = ret.Error(1)
	}
...
// GetTaskStatus provides a mock function with given fields: ctx, tx, taskID
func (_m *MockedDatabase) GetTaskStatus(ctx context.Context, tx pgx.Tx, taskID uuid.UUID) (int, error) {
	ret := _m.Called(ctx, tx, taskID)

	var r0 int
	if rf, ok := ret.Get(0).(func(context.Context, pgx.Tx, uuid.UUID) int); ok {
		r0 = rf(ctx, tx, taskID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(int)
...
// GetUsersWithReadWriteFormAccess provides a mock function with given fields: ctx, tx, workNumber, stepName
func (_m *MockedDatabase) GetUsersWithReadWriteFormAccess(ctx context.Context, tx pgx.Tx, workNumber string, stepName string) ([]entity.UsersWithFormAccess, error) {
	ret := _m.Called(ctx, tx, workNumber, stepName)

	var r0 []entity.UsersWithFormAccess
	if rf, ok := ret.Get(0).(func(context.Context, pgx.Tx, string, string) []entity.UsersWithFormAccess); ok {
		r0 = rf(ctx, tx, workNumber, stepName)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, pgx.Tx, string, string) error); ok {
		r1 = rf(ctx, tx, workNumber, stepName)
	} else {
		r1 = ret.Error(1)
	}
...
// GetTaskRunContext provides a mock function with given fields: ctx, tx, name
func (_m *MockedDatabase) GetTaskRunContext(ctx context.Context, tx pgx.Tx, name string) (entity.TaskRunContext, error) {
	ret := _m.Called(ctx, tx, name)

	var r0 entity.TaskRunContext
	if rf, ok := ret.Get(0).(func(context.Context, pgx.Tx, string) entity.TaskRunContext); ok {
		r0 = rf(ctx, tx, name)
	} else {
...
// SaveStepContext provides a mock function with given fields: ctx, tx, dto
func (_m *MockedDatabase) SaveStepContext(ctx context.Context, tx pgx.Tx, dto *db.SaveStepRequest) (uuid.UUID, time.Time, error) {
	ret := _m.Called(ctx, tx, dto)

	var r0 uuid.UUID
	if rf, ok := ret.Get(0).(func(context.Context, pgx.Tx, *db.SaveStepRequest) uuid.UUID); ok {
		r0 = rf(ctx, tx, dto)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 time.Time
	if rf, ok := ret.Get(1).(func(context.Context, pgx.Tx, *db.SaveStepRequest) time.Time); ok {
		r1 = rf(ctx, tx, dto)
	} else {
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(context.Context, pgx.Tx, *db.SaveStepRequest) error); ok {
		r2 = rf(ctx, tx, dto)
	} else {
		r2 = ret.Error(2)
	}
...
// UpdateStepContext provides a mock function with given fields: ctx, tx, dto
func (_m *MockedDatabase) UpdateStepContext(ctx context.Context, tx pgx.Tx, dto *db.UpdateStepRequest) error {
	ret := _m.Called(ctx, tx, dto)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, pgx.Tx, *db.UpdateStepRequest) error); ok {
		r0 = rf(ctx, tx, dto)
	} else {
		r0 = ret.Error(0)
	}
...
// UpdateTaskHumanStatus provides a mock function with given fields: ctx, tx, taskID, status
func (_m *MockedDatabase) UpdateTaskHumanStatus(ctx context.Context, tx pgx.Tx, taskID uuid.UUID, status string) error {
	ret := _m.Called(ctx, tx, taskID, status)
...
// StopTaskBlocks provides a mock function with given fields: ctx, tx, taskID
func (_m *MockedDatabase) StopTaskBlocks(ctx context.Context, tx pgx.Tx, taskID uuid.UUID) error {
	ret := _m.Called(ctx, tx, taskID)
