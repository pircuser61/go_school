...
type TaskStorager interface {
	...
	GetTask(ctx c.Context, tx pgx.Tx, workNumber string) (*e.EriusTask, error)
	...
	GetBlockDataFromVersion(ctx c.Context, tx pgx.Tx, workNumber, blockName string) (*e.EriusFunc, error)
