...
comment on constraint pipelines.pipelines_pkey on pipelines is 'Первичный ключ сценария.';
comment on index pipelines.pipelines_pkey is 'Индекс по первичному ключу сценария. Создан по умолчанию.';

comment on column pipelines.name is 'Название сценария.';
comment on constraint pipelines.uniq_name on pipelines is 'Внешний ключ по названию сценария.';
comment on index pipelines.uniq_name is 'Индекс созданный по внешнему ключу названия сценария.';
...
comment on constraint pipeline_history.pipeline_history_pk on pipeline_history is 'Первичный ключ по уникальному идентификатору записи изменения сценария.';
comment on index pipeline_history.pipeline_history_pk is 'Индекс по первичному ключу - уникальному идентификатору записи изменения сценария.';
...
comment on constraint versions.versions_pk on versions is 'Первичный ключ по уникальному идентификатору версии сценария.';
comment on index versions.versions_pk is 'Индекс по первичному ключу - идентификатор версии сценария.';

comment on column versions.pipeline_id is 'Идентификатор сценария.';
comment on index versions.versions_pipeline_id_index is 'Индекс по идентификатору сценария.';
...
comment on constraint version_status.version_status_pk on version_status is 'Первичный ключ уникального идентификатора статуса версии.';
comment on index version_status.version_status_pk is 'Индекс по первичному ключу - уникальный идентификатор статуса версии.';
...
comment on constraint works.works_pk on works is 'Первичный ключ по уникальному идентификатору запущенной заявки.';
comment on index works.works_pk is 'Индекс по первичному ключу - уникальному идентификатору запущенной заявки.';

comment on column works.work_number is 'Уникальный номер запущенной заявки по версии сценария.';
comment on index works.works_work_number_index is 'Индекс по номеру запущенной заявки.';
comment on index works.works_exp_index_filter is 'Индекс по номеру запущенной заявки.';

comment on column works.started_at is 'Дата запуска заявки по версии сценария.';
comment on index works.started_at_pr is 'Индекс по дате запуска заявки по версии сценария.';
comment on index works.works_started_at is 'Индекс по дате запуска заявки по версии сценария.';
...
comment on constraint work_status.work_status_pk on work_status is 'Первичный ключ по идентификатору статуса заявки.';
comment on index work_status.work_status_pk is 'Индекс по первичному ключу - идентификатору статуса заявки.';
...
comment on constraint variable_storage.variable_storage_pk on variable_storage is 'Первичный ключ по идентификатору записи перехода блока.';
comment on index variable_storage.variable_storage_pk is 'Индекс по первичному ключу - идентификатору записи перехода блока.';

comment on column variable_storage.work_id is 'Уникальный идентификатор заявки.';
comment on constraint variable_storage.works_id on variable_storage is 'Внешний ключ по идентификатору заявки.';
comment on constraint variable_storage.variable_storage_works_work_id_fk on variable_storage is 'Внешний ключ по идентификатору заявки.';
comment on index variable_storage.index_name is 'Индекс по идентификатору заявки.';
comment on index variable_storage.idx_variable_storage_work_id is 'Индекс по идентификатору заявки.';

comment on column variable_storage.status is 'Статус блока';
comment on index variable_storage.variable_storage_status_idx is 'Индекс по статусу блока.';
...
comment on index variable_storage.idxgin_content is 'Индекс по JSON содержимому.';

comment on column variable_storage.members is 'Участники процесса в конкретном блоке.';
comment on index variable_storage.index_members is 'Индекс по участникам процесса.';

comment on column variable_storage.step_type is 'Тип конкретного блока.';
comment on index variable_storage.variable_storage_step_type_idx is 'Индекс по типу блока.';
...
comment on index variable_storage.idx_variable_storage_work_id is 'Индекс по уникальному идентификатору заявки.';
comment on index variable_storage.variable_storage_work_id_step_type_status_index is 'Индекс по идентификатору заявки, статусу заявки и типу блока.';
comment on index variable_storage.count_index is 'Индекс по всем идентификаторам заявки с активным статусом.';
...
comment on constraint dict_actions.dict_actions_pkey on dict_actions is 'Первичный ключ по уникальному идентификатору записи доступного действия.';
comment on index dict_actions.dict_actions_pkey is 'Индекс по первичному ключу - уникальному идентификатору записи доступного действия.';
...
comment on constraint dict_approve_action_names.dict_approve_action_pkey on dict_approve_action_names is 'Первичный ключ по идентификатору пользовательского действия.';
comment on index dict_approve_action_names.dict_approve_action_pkey is 'Индекс по первичному ключу - идентификатору пользовательского действия.';
...
comment on constraint dict_approve_statuses.dict_approve_statuses_pkey on dict_approve_statuses is 'Первичный ключ по идентификатору статуса пользовательских действий.';
comment on index dict_approve_statuses.dict_approve_statuses_pkey is 'Индекс по первичному ключу - идентификатору статуса пользовательских действий.';
...
comment on constraint members.members_pkey on members is 'Первичный ключ по уникальному идентификатору записи об участнике.';
comment on index members.members_pkey is 'Индекс по первичному ключу - уникальному идентификатору записи об участнике.';

comment on column members.login is 'Логин участника процесса в рамках блока.';
comment on index members.index_logins is 'Индекс по всем логинам участников процесса в рамках блока.';

comment on column members.finished is 'Флаг того закончено ли участие пользователя в блоке.';
comment on index members.index_finish is 'Индекс по всем законченным участникам.';
...
comment on constraint pipelines.pipelines_pkey on pipelines is null;
comment on index pipelines.pipelines_pkey is null;

comment on column pipelines.name is null;
comment on constraint pipelines.uniq_name on pipelines is null;
comment on index pipelines.uniq_name is null;
...
comment on constraint pipeline_history.pipeline_history_pk on pipeline_history is null;
comment on index pipeline_history.pipeline_history_pk is null;
...
comment on constraint versions.versions_pk on versions is null;
comment on index versions.versions_pk is null;

comment on column versions.pipeline_id is null;
comment on index versions.versions_pipeline_id_index is null;
...
comment on constraint version_status.version_status_pk on version_status is null;
comment on index version_status.version_status_pk is null;
...
comment on constraint works.works_pk on works is null;
comment on index works.works_pk is null;

comment on column works.work_number is null;
comment on index works.works_work_number_index is null;
comment on index works.works_exp_index_filter is null;

comment on column works.started_at is null;
comment on index works.started_at_pr is null;
comment on index works.works_started_at is null;
...
comment on constraint work_status.work_status_pk on work_status is null;
comment on index work_status.work_status_pk is null;
...
comment on constraint variable_storage.variable_storage_pk on variable_storage is null;
comment on index variable_storage.variable_storage_pk is null;

comment on column variable_storage.work_id is null;
comment on constraint variable_storage.works_id on variable_storage is null;
comment on constraint variable_storage.variable_storage_works_work_id_fk on variable_storage is null;
comment on index variable_storage.index_name is null;
comment on index variable_storage.idx_variable_storage_work_id is null;

comment on column variable_storage.status is null;
comment on index variable_storage.variable_storage_status_idx is null;

comment on column variable_storage.content is null;
comment on index variable_storage.idxgin_content is null;

comment on column variable_storage.members is null;
comment on index variable_storage.index_members is null;

comment on column variable_storage.step_type is null;
comment on index variable_storage.variable_storage_step_type_idx is null;

comment on column variable_storage.time is null;
comment on index variable_storage_time_index is null;

comment on index variable_storage.idx_variable_storage_work_id is null;
comment on index variable_storage.variable_storage_work_id_step_type_status_index is null;
comment on index variable_storage.count_index is null;
...
comment on constraint dict_actions.dict_actions_pkey on dict_actions is null;
comment on index dict_actions.dict_actions_pkey is null;
...
comment on constraint dict_approve_action_names.dict_approve_action_pkey on dict_approve_action_names is null;
comment on index dict_approve_action_names.dict_approve_action_pkey is null;
...
comment on constraint dict_approve_statuses.dict_approve_statuses_pkey on dict_approve_statuses is null;
comment on index dict_approve_statuses.dict_approve_statuses_pkey is null;
...
comment on constraint log_storage.log_storage_pk on log_storage is null;
comment on index log_storage_pk is null;

comment on column log_storage.id_works is null;
comment on constraint log_storage.works_fk on log_storage is null;

comment on column log_storage.id_log_kind is null;
comment on constraint log_storage.log_kind_fk on log_storage is null;
...
comment on constraint log_kind.log_kind_pk on log_kind is null;
comment on index log_kind.log_kind_pk is null;
...
comment on constraint members.members_pkey on members is null;
comment on index members.members_pkey is null;

comment on column members.login is null;
comment on index members.index_logins is null;

comment on column members.finished is null;
comment on index members.index_finish is null;
